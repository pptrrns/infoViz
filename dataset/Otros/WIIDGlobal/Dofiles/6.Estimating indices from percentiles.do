	...
	* Bringing population and gdp
	merge m:1 c3 year using "C:\Users\rahul.lahoti\Dropbox\WIID update\WIID 2023\WIID Companion\Data\Metadata\gdp", keepus(gdp) update replace	
	drop if _m==2
	drop _m
	...
	* Stata file
	save "wiidcountry", replace
	* Excel file
	export excel using "wiidcountry.xlsx", firstrow(variables) replace	
	* Change layout manually (e.g., 2 decimals, ',' in thousands, frozen columns and rows)
